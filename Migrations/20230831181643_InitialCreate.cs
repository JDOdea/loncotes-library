    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "145 East Ocean Drive", "joshb@gmail.com", "Josh", true, "Baugh" },
                    { 2, "963 Highland St", "lizav@gmail.com", "Liza", true, "Vavrichyna" },
                    { 3, "2144 Fairview Lane", "jdfitz@gmail.com", "JD", false, "Fitzmartin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "Cat's Cradle", 1, null },
                    { 2, 1, "Good Omens", 5, null },
                    { 3, 1, "The Count of Monte Cristo", 1, null },
                    { 4, 7, "The New York Times", 2, null },
                    { 5, 2, "Tron: Legacy", 3, null },
                    { 6, 8, "OK Computer", 4, null },
                    { 7, 4, "La La Land", 3, null },
                    { 8, 6, "Unbroken", 5, null },
                    { 9, 8, "Trench", 4, null },
                    { 10, 5, "The Storyteller", 5, null }
                });
